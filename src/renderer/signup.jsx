...
export default class SignUp extends React.Component {
    ...
    handleOnSubmit(e) {
        const {email, name, password, photoURL} = this.state;
        const errors = [];
        ...
        return (
            <form style={SIGNUP_FORM_STYLE} onSubmit={this.handleOnSubmit}>
                ...
                <div className="form-group">
                    ...
                    <Link to="/login"><button type="button" style={CANCEL_BUTTON_STYLE} className="btn btn-large btn-default">Cancel</button></Link>
